...
namespace hpx { namespace mpi { namespace experimental {
    ...
    namespace detail {
        ...
        using request_callback_function_type = hpx::util::unique_function_nonser<void(int)>;

        HPX_EXPORT void add_request_callback(request_callback_function_type&& f, MPI_Request req);
    ...
    namespace detail {
            ...
            void add_callback()
            {
                add_request_callback(
                            ...
                            int status)
                        {
                            ...
                            //else
                            //{
                            //    //TODO: construct exception based on mpi code
        ...
        HPX_EXPORT std::vector<MPI_Request>& get_requests_vector();
